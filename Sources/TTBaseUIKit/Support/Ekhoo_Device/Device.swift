...
open class Device {
    ...
    static public func getVersionCode(detectSimulator: Bool = false) -> String {
    ...
    static public func getType(code: String, detectSimulator: Bool) -> Type {
    ...
    static public func version(detectSimulator: Bool = false) -> DeviceVersion {
