...
//  Modified from https://github.com/markiv/SwiftUI-Shimmer
...
public struct Shimmer: ViewModifier {
    ...
    struct AnimatedMask: AnimatableModifier {
        ...
        func body(content: Content) -> some View {
            ...
            }.cornerRadius(TTSize.CORNER_RADIUS)
        }
    }
    ...
    struct GradientMask: View {
        ...
        var body: some View {
            ...
            LinearGradient(gradient: Gradient(stops: [
                   .init(color: edgeColor, location: phase + 0.0),
                   .init(color: centerColor, location: phase + 0.14),
