...
open class TTBaseShadowTableViewCell: TTBaseUITableViewCell {
    
    open var bgShadown:UIColor { get { return UIColor.darkGray.withAlphaComponent(0.2) }}
    open var bgButton:UIColor { get { return .white } }
    
    override open var padding: (CGFloat, CGFloat, CGFloat, CGFloat) { get { return (TTSize.P_CONS_DEF * 2,TTSize.P_CONS_DEF,TTSize.P_CONS_DEF * 2,TTSize.P_CONS_DEF)}}
