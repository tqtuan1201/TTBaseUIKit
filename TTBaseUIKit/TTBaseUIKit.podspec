Pod::Spec.new do |s|
  ...
  s.source_files = "TTBaseUIKit/Classes/**/*.{swift}"
  s.exclude_files = "TTBaseUIKit/Classes/**/*.plist"
  s.swift_version = '5.0'
  #s.resources = 'TTBaseUIKit/Support/Fonts/*{.ttf}'
  s.resource_bundle = { 'TTBaseUIKit' => ['TTBaseUIKit/Classes/**/*.{ttf}','TTBaseUIKit/Classes/**/*.{png}'] }
